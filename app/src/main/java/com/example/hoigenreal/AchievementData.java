...
public class AchievementData {
    public static List<Achievement> getAllAchievements(){
        ...
        Achievement bearerOfArtillery = new Achievement("Bearer of Artillery", 0, 0,"Core");
        bearerOfArtillery.setNationFlag("Other");
        achievementList.add(bearerOfArtillery);

        Achievement bigEntente = new Achievement("Big Entente",1,0,"Core");
        bigEntente.setNationFlag("France");
        achievementList.add(bigEntente);

        Achievement canadaFirst = new Achievement("Canada First",2,0,"Core");
        canadaFirst.setNationFlag("Other");
        achievementList.add(canadaFirst);

        Achievement destroyerOfWorlds = new Achievement("Destroyer of Worlds",3,0,"Core");
        destroyerOfWorlds.setNationFlag("Any");
        achievementList.add(destroyerOfWorlds);

        Achievement duceNukedEm = new Achievement("Duce NUked'em",4,0,"Core");
        duceNukedEm.setNationFlag("Italy");
        achievementList.add(duceNukedEm);

        Achievement forgeOfVictory = new Achievement("Forge of Victory",5,0,"Core");
        forgeOfVictory.setNationFlag("Other");
        achievementList.add(forgeOfVictory);

        Achievement friendInNeed = new Achievement("Friend in Need",6,0,"Core");
        friendInNeed.setNationFlag("Any");
        achievementList.add(friendInNeed);

        Achievement masterOfWar = new Achievement("Master of War",7,0,"Core");
        masterOfWar.setNationFlag("Any");
        achievementList.add(masterOfWar);

        Achievement medPlutonium = new Achievement("Med plutonium",8,0,"Core");
        medPlutonium.setNationFlag("Other");
        achievementList.add(medPlutonium);

        Achievement mineIsBigger = new Achievement("Mine is bigger than yours",9,0,"Core");
        mineIsBigger.setNationFlag("Any");
        achievementList.add(mineIsBigger);

        Achievement newWorldOrder = new Achievement("New World Order",10,0,"Core");
        newWorldOrder.setNationFlag("Any");
        achievementList.add(newWorldOrder);

        Achievement noCountryForOldMen = new Achievement("No country for old men",11,0,"Core");
        noCountryForOldMen.setNationFlag("Any");
        achievementList.add(noCountryForOldMen);

        Achievement nobodyExpects = new Achievement("Nobody expects...",12,0,"Core");
        nobodyExpects.setNationFlag("Other");
        achievementList.add(nobodyExpects);

        Achievement northernLight = new Achievement("Northern Light",13,0,"Core");
        northernLight.setNationFlag("Other");
        achievementList.add(northernLight);

        Achievement onceMoreMate = new Achievement("Once More Mate",14,0,"Core");
        onceMoreMate.setNationFlag("Other");
        achievementList.add(onceMoreMate);

        Achievement oneEmpire = new Achievement("One Empire",15,0,"Core");
        oneEmpire.setNationFlag("Britain");
        achievementList.add(oneEmpire);

        Achievement operationSeaLion = new Achievement("Operation Sea Lion",16,0,"Core");
        operationSeaLion.setNationFlag("Germany");
        achievementList.add(operationSeaLion);

        Achievement partyLikeIts = new Achievement("Party like it's 1520",17,0,"Core");
        partyLikeIts.setNationFlag("Other");
        achievementList.add(partyLikeIts);

        Achievement polandCanIntoSpace = new Achievement("Poland Can Into Space",18,0,"Core");
        polandCanIntoSpace.setNationFlag("Other");
        achievementList.add(polandCanIntoSpace);

        Achievement sunsetInvasion = new Achievement("Sunset Invasion",19,0,"Core");
        sunsetInvasion.setNationFlag("Other");
        achievementList.add(sunsetInvasion);

        Achievement revengeOfMontezuma = new Achievement("The Revenge of Montezuma",20,0,"Core");
        revengeOfMontezuma.setNationFlag("Other");
        achievementList.add(revengeOfMontezuma);

        Achievement revolutionTriumphant = new Achievement("The Revolution Triumphant",21,0,"Core");
        revolutionTriumphant.setNationFlag("Soviet");
        achievementList.add(revolutionTriumphant);

        Achievement timeOnOurSide = new Achievement("Time is on our side",22,0,"Core");
        timeOnOurSide.setNationFlag("Any");
        achievementList.add(timeOnOurSide);

        Achievement transportTycoon = new Achievement("Transport Tycoon",23,0,"Core");
        transportTycoon.setNationFlag("Any");
        achievementList.add(transportTycoon);

        Achievement trueBlitzkrieg = new Achievement("True Blitzkrieg",24,0,"Core");
        trueBlitzkrieg.setNationFlag("Germany");
        achievementList.add(trueBlitzkrieg);

        Achievement unitedNetherlands = new Achievement("United Blitzkrieg",25,0,"Core");
        unitedNetherlands.setNationFlag("Other");
        achievementList.add(unitedNetherlands);

        Achievement viveLaFrance = new Achievement("Vive la France",26,0,"Core");
        viveLaFrance.setNationFlag("France");
        achievementList.add(viveLaFrance);

        Achievement builtItInADay = new Achievement("We'll Build it in a Day",27,0,"Core");
        builtItInADay.setNationFlag("Any");
        achievementList.add(builtItInADay);

        Achievement wunderwaffen = new Achievement("Wunderwaffen",28,0,"Core");
